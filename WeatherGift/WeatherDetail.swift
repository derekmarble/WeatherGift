...
class WeatherDetail: WeatherLocation {
    ...
    private struct Weather: Codable {
        //for accessing the first element of the weather array from OpenWeather API
        var description: String
        var icon: String
        // json codes for getting icons for hourly weather data
        var id: Int
    }
...
//                let json = try JSONSerialization.jsonObject(with: data!, options: [])
                ...
                //transform elements in daily data into the correct format that we want!
